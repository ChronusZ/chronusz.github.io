...
A node is called **nonfaulty** if it behaves according to the protocol, and does not stay halted forever. A thread $$S$$ is called **nonfaulty** if the number of *faulty* nodes in $$S$$ is no greater than $$f_S$$.
